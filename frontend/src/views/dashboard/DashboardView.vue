  ...
  <div class="page" v-loading="loading">
    ...
    <div class="stat-grid">
      ...
      <StatCard
        ...
        :hint="`已完成 ${overview.task.by_status.completed} / 应完成 ${overview.task.countable} 项（已取消不计入）`"
        tone="info"
        icon="CircleCheck"
      />
      <StatCard
...
function emptyDashboard() {
  return {
    overview: {
      ...
      task: { total: 0, open_count: 0, overdue_count: 0, due_soon_count: 0, completion_rate: 0, countable: 0, by_status: {} },
